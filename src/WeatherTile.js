          ...
          <div className="info-side">
            <div className="today-info-container">
              <div className="today-info">
                ...
                <div className="humidity"> <span className="title">CLOUDS</span><span className="value">{this.props.data.clouds ? this.props.data.clouds.all : ''} %</span>
                  <div className="clear"></div>
                </div>
                <div className="wind"> <span className="title">WIND</span><span className="value">{this.props.data.wind ? this.props.data.wind.speed : ''} mph</span>
                  <div className="clear"></div>
                </div>
              </div>
            </div>
